...
<html lang="en" data-bs-theme="dark">
    ...
    <div id="courseCarousel" class="carousel slide mb-5" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="assets/uploads/slide2.jpeg" class="d-block w-100" alt="Course 2">
                <div class="carousel-caption d-none d-md-block">
                </div>
            </div>

            <div class="carousel-item">
                <img src="assets/uploads/slide3.jpeg" class="d-block w-100" alt="Course 3">
                <div class="carousel-caption d-none d-md-block">
                </div>
            </div>
        </div>
    ...
    <div class="text-center">
        ...
        <p>Manage your books using the navbar above.</p>
    </div>
